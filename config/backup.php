    ...
    'backup' => [
        ...
        'source' => [
            'files' => [
                 ...
                 * For SQLite, we include the database file directly since sqlite3 CLI may not be available.
                 */
                'include' => [
             ...
             *
             * For SQLite: Leave empty since we include the file directly above.
             * For MySQL/PostgreSQL: Use the db-dumper.
             */
            'databases' => env('DB_CONNECTION', 'sqlite') === 'sqlite' ? [] : [
                env('DB_CONNECTION'),
            ],
        ],
